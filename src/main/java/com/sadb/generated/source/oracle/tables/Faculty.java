...
public class Faculty extends TableImpl<FacultyRecord> {
    ...
    private static final long serialVersionUID = -259720029;

    /**
     * The reference instance of <code>USER1.FACULTY</code>
     */
    ...
    /**
     * The column <code>USER1.FACULTY.FAC_ID</code>.
     */
    public final TableField<FacultyRecord, BigInteger> FAC_ID = createField("FAC_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * The column <code>USER1.FACULTY.FAC_NAME</code>.
     */
    public final TableField<FacultyRecord, String> FAC_NAME = createField("FAC_NAME", org.jooq.impl.SQLDataType.VARCHAR(250), this, "");

    /**
     * The column <code>USER1.FACULTY.MEGAFAC_ID</code>.
     */
    public final TableField<FacultyRecord, BigInteger> MEGAFAC_ID = createField("MEGAFAC_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * The column <code>USER1.FACULTY.CREAT_TIME</code>.
     */
    public final TableField<FacultyRecord, Date> CREAT_TIME = createField("CREAT_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * The column <code>USER1.FACULTY.UPDATE_TIME</code>.
     */
    public final TableField<FacultyRecord, Date> UPDATE_TIME = createField("UPDATE_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * Create a <code>USER1.FACULTY</code> table reference
     */
    public Faculty() {
    ...
    /**
     * Create an aliased <code>USER1.FACULTY</code> table reference
     */

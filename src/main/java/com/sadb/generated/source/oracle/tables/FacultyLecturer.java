...
public class FacultyLecturer extends TableImpl<FacultyLecturerRecord> {
    ...
    private static final long serialVersionUID = 1999645995;

    /**
     * The reference instance of <code>USER1.FACULTY_LECTURER</code>
     */
    ...
    /**
     * The column <code>USER1.FACULTY_LECTURER.FAC_ID</code>.
     */
    public final TableField<FacultyLecturerRecord, BigInteger> FAC_ID = createField("FAC_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * The column <code>USER1.FACULTY_LECTURER.FAC_LECT_ID</code>.
     */
    public final TableField<FacultyLecturerRecord, BigInteger> FAC_LECT_ID = createField("FAC_LECT_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * The column <code>USER1.FACULTY_LECTURER.CREAT_TIME</code>.
     */
    public final TableField<FacultyLecturerRecord, Date> CREAT_TIME = createField("CREAT_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * The column <code>USER1.FACULTY_LECTURER.UPDATE_TIME</code>.
     */
    public final TableField<FacultyLecturerRecord, Date> UPDATE_TIME = createField("UPDATE_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * The column <code>USER1.FACULTY_LECTURER.LEC_ID</code>.
     */
    public final TableField<FacultyLecturerRecord, BigInteger> LEC_ID = createField("LEC_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * Create a <code>USER1.FACULTY_LECTURER</code> table reference
     */
    ...
    /**
     * Create an aliased <code>USER1.FACULTY_LECTURER</code> table reference
     */
    ...
    public List<ForeignKey<FacultyLecturerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<FacultyLecturerRecord, ?>>asList(Keys.R_15, Keys.R_16);
    }

...
public class VariantOccupation extends TableImpl<VariantOccupationRecord> {
    ...
    private static final long serialVersionUID = 610314907;

    /**
     * The reference instance of <code>USER1.VARIANT_OCCUPATION</code>
     */
    ...
    /**
     * The column <code>USER1.VARIANT_OCCUPATION.VARIANT_OCCUPATION_ID</code>.
     */
    public final TableField<VariantOccupationRecord, BigInteger> VARIANT_OCCUPATION_ID = createField("VARIANT_OCCUPATION_ID", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(38).nullable(false), this, "");

    /**
     * The column <code>USER1.VARIANT_OCCUPATION.VAR_OCC_TYPE</code>.
     */
    ...
    /**
     * The column <code>USER1.VARIANT_OCCUPATION.CREAT_TIME</code>.
     */
    public final TableField<VariantOccupationRecord, Date> CREAT_TIME = createField("CREAT_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * The column <code>USER1.VARIANT_OCCUPATION.UPDATE_TIME</code>.
     */
    public final TableField<VariantOccupationRecord, Date> UPDATE_TIME = createField("UPDATE_TIME", org.jooq.impl.SQLDataType.DATE, this, "");

    /**
     * Create a <code>USER1.VARIANT_OCCUPATION</code> table reference
     */
    ...
    /**
     * Create an aliased <code>USER1.VARIANT_OCCUPATION</code> table reference
     */

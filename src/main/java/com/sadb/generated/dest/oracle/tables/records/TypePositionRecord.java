...
public class TypePositionRecord extends UpdatableRecordImpl<TypePositionRecord> implements Record4<Long, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1399996889;

    /**
     * Setter for <code>SANDDB.TYPE_POSITION.ID</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_POSITION.ID</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>SANDDB.TYPE_POSITION.NAME</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_POSITION.NAME</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.TYPE_POSITION.DATA_UPDATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_POSITION.DATA_UPDATE</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.TYPE_POSITION.DATA_CREATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_POSITION.DATA_CREATE</code>.
     */
     ...
     */
    @Override
    public TypePositionRecord value1(Long value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public TypePositionRecord values(Long value1, String value2, Timestamp value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypePositionRecord(Long id, String name, Timestamp dataUpdate, Timestamp dataCreate) {
        super(TypePosition.TYPE_POSITION);

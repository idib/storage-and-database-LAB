...
public class DormitoryRecord extends UpdatableRecordImpl<DormitoryRecord> implements Record5<Long, String, String, Timestamp, Timestamp> {
    ...
    /**
     * Getter for <code>SANDDB.DORMITORY.ID</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>SANDDB.DORMITORY.NAME</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.DORMITORY.NAME</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.DORMITORY.ADDRESS</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.DORMITORY.ADDRESS</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.DORMITORY.DATE_UPDATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.DORMITORY.DATE_UPDATE</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.DORMITORY.DATE_CREATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.DORMITORY.DATE_CREATE</code>.
     */
     ...
     */
    @Override
    public DormitoryRecord value1(Long value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public DormitoryRecord values(Long value1, String value2, String value3, Timestamp value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DormitoryRecord(Long id, String name, String address, Timestamp dateUpdate, Timestamp dateCreate) {
        super(Dormitory.DORMITORY);

...
public class TypeEditionRecord extends UpdatableRecordImpl<TypeEditionRecord> implements Record4<Long, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = -482824705;

    /**
     * Setter for <code>SANDDB.TYPE_EDITION.ID</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_EDITION.ID</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>SANDDB.TYPE_EDITION.NAME</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_EDITION.NAME</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.TYPE_EDITION.DATA_UPDATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_EDITION.DATA_UPDATE</code>.
     */
    ...
    /**
     * Setter for <code>SANDDB.TYPE_EDITION.DATA_CREATE</code>.
     */
    ...
    /**
     * Getter for <code>SANDDB.TYPE_EDITION.DATA_CREATE</code>.
     */
     ...
     */
    @Override
    public TypeEditionRecord value1(Long value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public TypeEditionRecord values(Long value1, String value2, Timestamp value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TypeEditionRecord(Long id, String name, Timestamp dataUpdate, Timestamp dataCreate) {
        super(TypeEdition.TYPE_EDITION);
